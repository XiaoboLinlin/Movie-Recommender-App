...
function get_movie_details(movie_id,my_api_key,arr,movie_title) {
  $.ajax({
    ...
    success: function(movie_details){ // movie_details is returned from the server
...
function show_details(movie_details,arr,movie_title,my_api_key,movie_id){
  var imdb_id = movie_details.imdb_id; //movie_details.imdb_id or movie_details.poster_path .. from remote server
